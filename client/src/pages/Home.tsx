...
const dishes = [
  { name: "Churrasquito", category: "Especial de la casa", image: "/manus-storage/carne-parrilla-carrusel_3d82cdda.webp", description: "Corte de res tierno, dorado a la plancha y servido con papa, mazorca, guacamole y hogao.", price: "$16.000" },
  { name: "Churrasco", category: "Especial de la casa", image: "/manus-storage/carne-parrilla-carrusel_3d82cdda.webp", description: "Una porción generosa de carne asada, con papa, mazorca, guacamole y el sabor de la casa.", price: "$21.000" },
